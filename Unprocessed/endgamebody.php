...
<div class='row divDropDownRow'>
    <div class='col-xs-18'>Division:</div>
    <div class='col-xs-30'>
...
if (isset($_POST['password'])) {
    ...
    switch ($div) {
        case "00":
            echo "
                <div class='row'>
                    <div class='col-xs-18'>Home Team:</div>
                    <div class='col-xs-30'>
                        <select id='homeTeam'>
                ...
                <div class='row'>
                    <div class='col-xs-18'>Home Score:</div>
                    <div class='col-xs-18'><input type='number' id='homeScore'></div>
                    <div class='col-xs-12'>Defaulted: <input type='checkbox' id='homeCheckbox' value='Defaulted'></div>
                </div>
                
                <div class='row'>
                    <div class='col-xs-18'>Away Team:</div>
                    <div class='col-xs-30'>
                        <select id='awayTeam'>
                            <option value='00'>Ashley</option>
                            <option value='01'>BDI</option>
                ...
                <div class='row'>
                    <div class='col-xs-18'>Away Score:</div>
                    <div class='col-xs-18'><input type='number' id='awayScore'></div>
                    <div class='col-xs-12'>Defaulted: <input type='checkbox' id='awayCheckbox' value='Defaulted'></div>
                </div>
                
                <div class='row'>
                    <div class='col-xs-18'>Date:</div>
                    <div class='col-xs-30'><input type='date' id='datePicker'></div>
                </div>
                
                <div class='row'>
                    <div class='col-xs-48'><button class='submitScore' onClick='submitScore();'>Submit Score</button></div>
                </div>";
            break;
        case "01":
            echo "
